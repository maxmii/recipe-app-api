...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_delete_other_users_recipe_error(self):
        """Test tryt to delete another users recipe gives an error"""
        new_user = create_user(
            email='user2@example.com', password='testpass123'
        )
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 20,
            'price': Decimal('7.00'),
            'ingredients': [{'name': 'Pepper'}, {'name': 'Curry Powder'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        ingredient_two = Ingredient.objects.create(user=self.user, name='Beef')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Chicken Orzo')
        r2 = create_recipe(user=self.user, title='Pizz')

        ing1 = Ingredient.objects.create(user=self.user, name='Chicken')
        ing3 = Ingredient.objects.create(user=self.user, name='Mozzarella')

        r3 = create_recipe(user=self.user, title='Chicken Noodle Soup')
